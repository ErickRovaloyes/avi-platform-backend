...
INSERT IGNORE INTO model_pricing (model, provider, input_per_1k, output_per_1k, display_name) VALUES
  ...
  ('deepseek-v4-flash',        'deepseek',  0.000270, 0.001100, 'DeepSeek V4 Flash'),
  ('deepseek-v4-pro',          'deepseek',  0.000550, 0.002190, 'DeepSeek V4 Pro'),
  ('deepseek-chat',            'deepseek',  0.000270, 0.001100, 'DeepSeek Chat (legado)'),
  ('deepseek-reasoner',        'deepseek',  0.000550, 0.002190, 'DeepSeek Reasoner (legado)'),

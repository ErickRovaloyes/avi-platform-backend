...
const saveConfig = async (req, res) => {
  ...
  try {
    ...
    const cfg = {
      ...
      // Gestión de pedidos por la IA (crear pedidos). Off = solo consulta; humano gestiona.
      ordersEnabled: b.ordersEnabled != null ? !!b.ordersEnabled : (cur.ordersEnabled !== false),
